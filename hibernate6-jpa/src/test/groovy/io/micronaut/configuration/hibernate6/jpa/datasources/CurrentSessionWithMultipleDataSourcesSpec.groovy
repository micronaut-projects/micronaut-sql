 ...
 */
package io.micronaut.configuration.hibernate6.jpa.datasources


import io.micronaut.configuration.hibernate6.jpa.datasources.db1.ProductRepository
import io.micronaut.configuration.hibernate6.jpa.datasources.db2.BookstoreMethodLevelTransaction
import io.micronaut.configuration.hibernate6.jpa.datasources.db2.BookstoreRepository
...
class CurrentSessionWithMultipleDataSourcesSpec extends Specification {
    ...
    void "test an application that defines 2 datasources uses correct transaction management"() {
        ...
        def context = ApplicationContext.run(
                ...
                'jpa.default.entity-scan.packages': ['io.micronaut.configuration.hibernate6.jpa.datasources.db1'],
                'jpa.default.properties.hibernate.hbm2ddl.auto':'create-drop',
                'jpa.db2.properties.hibernate.hbm2ddl.auto':'create-drop',
                'jpa.db2.entity-scan.packages': ['io.micronaut.configuration.hibernate6.jpa.datasources.db2'],
        )
