...
package io.micronaut.configuration.jdbi.transaction.data;
...
public class MicronautTransactionHandler extends AbstractTransactionHandler {
     ...
     */
    public MicronautTransactionHandler(DataSourceTransactionManager transactionManager) {
