Micronaut supports reactive and non-blocking client to connect to PostgreSQL and MySQL using https://github.com/jasync-sql/jasync-sql[jasync-sql], allowing to handle many database connections with a single thread.
