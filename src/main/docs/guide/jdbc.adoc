...
WARNING: The unpooled datasource creates a new connection for each request and should only be used for testing, serverless, or very low-volume applications. See the link:jdbc-unpooled.html[Unpooled JDBC DataSources] documentation for details.
