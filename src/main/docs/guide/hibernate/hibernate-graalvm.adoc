...
snippet::io.micronaut.docs.hibernate.entityscan.Application[tags="imports,clazz"]
...
snippet::io.micronaut.docs.hibernate.proxies.Owner[tags="imports,clazz"]
...
snippet::io.micronaut.docs.hibernate.proxies.Pet[tags="imports,clazz"]
...
snippet::io.micronaut.docs.hibernate.graalvm.OrderId[tags="imports,clazz"]

And then used from the entity as usual:

snippet::io.micronaut.docs.hibernate.graalvm.Order[tags="imports,clazz"]
