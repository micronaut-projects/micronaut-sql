...
snippet::io.micronaut.docs.hibernate.entityscan.Application[tags="imports,clazz", languages="java,kotlin,groovy", title="Generating Introspection Metadata for External Classes"]
