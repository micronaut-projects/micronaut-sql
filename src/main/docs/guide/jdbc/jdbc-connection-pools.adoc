...
The `micronaut-jdbc-ucp` module uses Oracle's `ojdbc17` and `ucp17` artifacts by default. Oracle's `ojdbc11` and `ucp11` artifacts remain managed for applications that need the JDK 11 driver line.
