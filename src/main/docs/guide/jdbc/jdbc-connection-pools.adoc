...
|Unpooled
|link:{jdkapi}/java.sql/javax/sql/DataSource.html[DataSource]
|https://micronaut-projects.github.io/micronaut-sql/latest/guide/configurationreference.html#io.micronaut.configuration.jdbc.unpooled.DatasourceConfiguration[DatasourceConfiguration]
|link:jdbc-unpooled.html[Unpooled JDBC DataSources]

|=======

NOTE: The unpooled implementation creates a new connection for each request. It should only be used for testing, serverless, or very low-volume applications. See link:jdbc-unpooled.html[Unpooled JDBC DataSources] for details.
