...
NOTE: Micronaut SQL 5.7.0 allowed disabling datasources via setting `datasources.enabled` to `false. That it is no longer supported. If you have multiple datasources you have to disable them all individually.
