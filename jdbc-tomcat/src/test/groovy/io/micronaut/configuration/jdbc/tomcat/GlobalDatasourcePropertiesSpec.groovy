...
class GlobalDatasourcePropertiesSpec extends Specification {
    ...
    void "test no global datasource configuration exists when no global properties are present"() {
        ...
        datasourceConfig.get().dbProperties.isEmpty()
    ...
    void "test global properties are applied to all datasource configurations"() {
        ...
        datasourceConfigs[0].dbProperties['ApplicationName'] == 'GlobalApp'
        datasourceConfigs[0].dbProperties['assumeMinServerVersion'] == '9.0'
        datasourceConfigs[1].dbProperties['ApplicationName'] == 'GlobalApp'
        datasourceConfigs[1].dbProperties['assumeMinServerVersion'] == '9.0'
