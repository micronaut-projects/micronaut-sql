...
@Factory
public class R2dbcJooqConfigurationFactory {
  ...
  public Configuration jooqConfiguration(
    ...
    R2dbcJooqConfigurationProperties properties =
        ctx.findBean(R2dbcJooqConfigurationProperties.class, Qualifiers.byName(name))
           .orElseGet(R2dbcJooqConfigurationProperties::new);
    ...
    configuration.setSettings(settings.withBindOffsetDateTimeType(true));
    ...
    configuration.setTransactionListenerProvider(
        ctx.getBeansOfType(TransactionListenerProvider.class, Qualifiers.byName(name))
           .toArray(new TransactionListenerProvider[0]));
    configuration.setDiagnosticsListenerProvider(
        ctx.getBeansOfType(DiagnosticsListenerProvider.class, Qualifiers.byName(name))
