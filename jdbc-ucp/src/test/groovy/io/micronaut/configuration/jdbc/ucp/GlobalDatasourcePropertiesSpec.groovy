...
class GlobalDatasourcePropertiesSpec extends Specification {
    ...
    void "test no global datasource configuration exists when no global properties are present"() {
        ...
        datasourceConfig.get().delegate.connectionProperties.isEmpty()
    ...
    void "test global properties are applied to all datasource configurations"() {
        ...
        datasourceConfigs[0].delegate.connectionProperties['ApplicationName'] == 'GlobalApp'
        datasourceConfigs[0].delegate.connectionProperties['assumeMinServerVersion'] == '9.0'
        datasourceConfigs[1].delegate.connectionProperties['ApplicationName'] == 'GlobalApp'
        datasourceConfigs[1].delegate.connectionProperties['assumeMinServerVersion'] == '9.0'
    ...
    void "test individual datasource properties override global properties"() {
        ...
        datasourceConfig.delegate.connectionProperties['ApplicationName'] == 'SpecificApp' // Overridden
        datasourceConfig.delegate.connectionProperties['specificProperty'] == 'specificValue' // Individual property
        datasourceConfig.delegate.connectionProperties['assumeMinServerVersion'] == '9.0' // Added from global
        datasourceConfig.delegate.connectionProperties['globalProperty'] == 'globalValue' // Added from global
