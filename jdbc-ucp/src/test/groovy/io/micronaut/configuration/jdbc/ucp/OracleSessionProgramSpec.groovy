...
class OracleSessionProgramSpec extends Specification {
    ...
    void "sets program for oracle dialect by default"() {
        ...
        when:
        PoolDataSource ds = resolver.resolve(ctx.getBean(DataSource))

        then:
        ds.getConnectionProperties().getProperty('v$session.program') == 'MyApp'
    ...
    void "respects user override for program"() {
        ...
        then:
        ds.getConnectionProperties().getProperty('v$session.program') == 'UserSet'
    ...
    void "disable flag prevents setting program"() {
        ...
        then:
        ds.getConnectionProperties().getProperty('v$session.program') == null
