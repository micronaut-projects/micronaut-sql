...
class GlobalDatasourcePropertiesSpec extends Specification {
    ...
    void "test no global datasource configuration exists when no global properties are present"() {
        ...
        datasourceConfig.get().dataSourceProperties.isEmpty()
    ...
    void "test global properties are applied to all datasource configurations"() {
        ...
        datasourceConfigs[0].dataSourceProperties['ApplicationName'] == 'GlobalApp'
        datasourceConfigs[0].dataSourceProperties['assumeMinServerVersion'] == '9.0'
        datasourceConfigs[1].dataSourceProperties['ApplicationName'] == 'GlobalApp'
        datasourceConfigs[1].dataSourceProperties['assumeMinServerVersion'] == '9.0'
    ...
    void "test individual datasource properties override global properties"() {
        ...
        datasourceConfig.dataSourceProperties['ApplicationName'] == 'SpecificApp' // Overridden
        datasourceConfig.dataSourceProperties['specificProperty'] == 'specificValue' // Individual property
        datasourceConfig.dataSourceProperties['assumeMinServerVersion'] == '9.0' // Added from global
        datasourceConfig.dataSourceProperties['globalProperty'] == 'globalValue' // Added from global
