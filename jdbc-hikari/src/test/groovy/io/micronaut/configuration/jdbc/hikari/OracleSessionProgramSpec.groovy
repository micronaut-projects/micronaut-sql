...
class OracleSessionProgramSpec extends Specification {
    ...
    void "sets program for oracle dialect by default"() {
        ...
        when:
        HikariUrlDataSource ds = resolver.resolve(ctx.getBean(DataSource))

        then:
        ds.getDataSourceProperties().getProperty('v$session.program') == 'MyApp'
    ...
    void "respects user override for program"() {
        ...
        then:
        ds.getDataSourceProperties().getProperty('v$session.program') == 'UserSet'
    ...
    void "disable flag prevents setting program"() {
        ...
        then:
        ds.getDataSourceProperties().getProperty('v$session.program') == null
